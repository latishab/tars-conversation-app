    ...
    async def _fire_intervention(self, trigger_type: str, context_snippet: str, hesitation_score: int = 0):
        ...
        if self._task_context:
            ...
            post_intervention_note = (
                ...
                "If they accept your offer or say they need help (e.g. 'yes please', 'yes', "
                "'yeah', 'I need help', 'I'm confused'), give a Suggestion-level nudge only — "
                "a direction or angle to think about, not the answer and not a full explanation. "
                "The answer is only given when the user explicitly gives up (CONDITION A)."
            )
            if trigger_type == "silence":
                system_content = (
                    ...
                    f"This is a Notification-level intervention. Signal you're available — reference "
                    f"the specific thing they were last working on. Do not offer a hint or nudge unprompted.\n"
                    f"Good: \"That last one still giving you trouble — need a nudge?\"\n"
                ...
                system_content = (
                    ...
                    f'Recent context: "{context_snippet}"\n\n'
                    f"This is a Suggestion-level intervention. Offer a gentle nudge — a direction or "
                    f"angle to think about. Do not name or suggest specific answers, solutions, or "
                    f"words — not even as examples. A category, a related concept, or a different "
                    f"angle only. Look back through conversation history for what they were last "
                    f"working on. One sentence. Just respond naturally."
                    f"{post_intervention_note}"
                    f"{no_context_escape}"
                    f"{express_reminder}"
                    f"{probe_note}"
                ...
                system_content = (
                    ...
                    f'Recent context: "{context_snippet}"\n\n'
                    f"This is a Suggestion-level intervention. Offer a helpful nudge — a direction or "
                    f"angle to think about. Do not name or suggest specific answers, solutions, or "
                    f"words — not even as examples. A category, a related concept, or a different "
                    f"angle only. Look back through conversation history for what they were last "
                    f"working on. One sentence. Just respond naturally."
